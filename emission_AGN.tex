...
\begin{table}
    \caption{Ionization Energies of some (mainly UV) emisson lines\\
      $^{a}$\href{http://physics.nist.gov/PhysRefData/Handbook/Tables/heliumtable4\_a.htm\#4685.3769}{http://physics.nist.gov/PhysRefData/Handbook/Tables/heliumtable4\_a.htm\#4685.3769}
%$^{b}$There are many Persistent Lines of e.g., Singly Ionized Helium ( He II ). The Configuration for \heii $\lambda$1640 is 2p,s and 3d,p,s.  The Configuration for \heii $\lambda$4686 is 3d,p,s and 4d,p,f. 
}
...
%        \hline
        ...
        $^{a,b}$\heii    & 1640                      & $^2$S$_{\frac{1}{2}}$         &   n/a                                            &  54.417\\
        $^{a,b}$\heii    & 4686                      &                                     &                                                      &  54.417        \\       
...
\section{IR fine-structure lines}
e.g. arXiv:1903.00946v1, Section 3:: \\
1 coronal region line: [SiVII] 6.50 μm;
8 AGN fine-structure emission lines: [NeVI]7.65,
[ArV]7.90, [CaV]11.48, [ArV]13.09, [MgV]13.50,
[NeV] 14.32, [NeV] 24.31 and [OIV] 25.89 μm;
...
\clearpage
%% http://www.physics.ohio-state.edu/~lvw/handyinfo/ips.jpg

\begin{sidewaysfigure}[ht]
    \includegraphics[height=18.5cm,width=26.0cm]{ips.jpg}
...
\section{HST/COS lines}
From Miller et al. arXiv:809.03114v1 \\
